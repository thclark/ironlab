...
// Why: Reset undoes navigation, not content choices; a user who hid a series should not see it reappear because
...
// Why: Reset and double-click throw away every view change at once, which is exactly the action a user is most
