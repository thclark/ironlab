...
| [0006](0006-interaction-mutates-the-ir.md) | Viewer interaction edits the IR, views reset from a snapshot, and linked axes form disjoint groups whose automatic limits are shared. | Accepted |
