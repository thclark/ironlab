...
| [0011](0011-colour-scales-are-nodes.md) | A colour scale is a node of the figure that axes and artists refer to by identifier and that is edited at its own property paths; it carries its own levels, a colormap is a built-in name or a list of colours, and a colorbar is an optional property of an axes that shows the scale of that axes. | Accepted |
